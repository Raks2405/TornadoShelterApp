/**
 * Tornado Shelter Alert Cloud Functions
 * -------------------------------------
 * - Provides REST API endpoints for device registration, weather info, and manual push.
 * - Schedules periodic checks for personalized tornado alerts.
 */
...
const { fetchTornadoIndicators } = require("./weatherService.js");
...
// ---------- SCHEDULED ALERT ----------
const tornadoScheduler = onSchedule(
  {
    schedule: "every 15 minutes",
    region: "us-central1",
    secrets: [METEO_USERNAME, METEO_PASSWORD], // Only scheduler needs these
  },
  async () => {
...
// ---------- MAIN API (Cloud Function HTTP entrypoint) ----------
const api = onRequest({ region: "us-central1" }, app);

// ---------- EXPORTS ----------
module.exports = { api, tornadoScheduler };
