...
const ShelterMarker = ({ s, onPress }: { s: Shelter; onPress: (s: Shelter) => void }) => {
  console.log("Rendering marker:", s.name, s.latitude, s.longitude);
  return (
    ...
    >
      ...
      <View
        style={{
          ...
          height: 36,
          borderRadius: 18,
          backgroundColor: "#10B981", // ✅ ensures visibility
          justifyContent: "center",
          alignItems: "center",
          borderWidth: 2,
          borderColor: "#fff",
          zIndex: 9999, // ✅ forces render above map tiles
        }}
      >
        <Ionicons name="home" size={18} color="#fff" />
      </View>

      {/* ✅ Properly rendered callout */}
