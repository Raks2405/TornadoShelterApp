...
export default function App() {
  ...
  // ---- Sort & slice (only top 10 in scroll) ----
  const nearest10 = useMemo(() => {
    if (!userLocation) return shelters.slice(0, 10);
    return [...shelters]
      .map((s) => ({
        ...s,
      ...
      >
        {shelters.map((s) => (
          ...
          >
            ...
            {/* Callout (clickable address) */}
            <Callout tooltip={false} onPress={() => openDirections(s)}>
